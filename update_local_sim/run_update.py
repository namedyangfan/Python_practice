...
def run_update(remote_directory, local_directory, simu_done,ldebug):
...
# optional argument
parser.add_argument("--cp_files", dest="cp_files", action="store_true", help="copy files without walk through the list file [default: %(default)s]")
...
simu_done = args.cp_files
# other options
ldebug = args.debug


run_update(remote_directory=remote_directory, local_directory=local_directory, simu_done=simu_done, ldebug=ldebug)